...
- **Outline bookmarks** — 227 two-level bookmarks (chapters + sections) added to combined PDF
- **Local cross-references** — 216 hyperlinks rewritten from website URLs to offline file jumps (LINK_GOTOR)
...
- **Files** — 62 chapters split into 66 individual PDFs (index + root chapters + guide/reference hierarchy)
- **Generation time** — ~1 second for full Addon SDK split
